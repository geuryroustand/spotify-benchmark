  ...
  return (
    <header class="header">
      ...
      <nav class="w-100 navbar mt-4">
        <ul class="w-100">
          <li class="font-weight-bold p-2 navbar-active">
            <a href="home.html">
              {" "}
              <i class="fas fa-home mt-2 fa-1x"> </i>Home
            </a>
          </li>
          <li class="font-weight-bold p-2">
            <a href="#">
              {" "}
              <i class="fas fa-search mt-2 fa-1x"></i>Search
            </a>
          </li>
          ...
          <div class="mt-5">
            <a href="#">
              ...
              <span class="pl-2"> Create Playlist </span>
            </a>
            <br />
            <br />
            <a href="#">
              ...
              <span class="pl-2"> Liked Songs </span>
            </a>
          </div>
        </ul>
      </nav>
      ...
      <ul class="middle-ul pr-3">
        ...
        <li>
          <a href="#"> This Is Rod Stevwart</a>
        </li>
        <li>
          <a href="#"> Francise ft Young Thug</a>
        </li>
      </ul>
      ...
      <p class="download">
        <a href="#">
          {" "}
          <i class="fas fa-arrow-down"></i> Install App{" "}
        </a>
      </p>
    </header>
  );
